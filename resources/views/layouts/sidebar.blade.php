<div class="sidebar-menu">
    <ul class="menu">
        ...
        <li class="sidebar-item {{ $menu === 'master' ? 'active' : '' }} has-sub">
            <a href="#" class='sidebar-link'>
                <i class="bi bi-stack"></i>
                <span>Master Data</span>
            </a>

            <ul class="submenu {{ $sub_menu === 'submenu' ? 'active' : '' }}">

                <li class="submenu-item {{ $item_menu === 'user' ? 'active' : '' }} ">
                    <a href="{{ url('user') }}" class="submenu-link">User</a>
                </li>

                <li class="submenu-item {{ $item_menu === 'pangkat' ? 'active' : '' }} ">
                    <a href="{{ url('pangkat') }}" class="submenu-link">Pangkat/Gol</a>
                </li>

                <li class="submenu-item {{ $item_menu === 'jamkerja' ? 'active' : '' }} ">
                    <a href="{{ url('jamkerja') }}" class="submenu-link">Jam Kerja</a>
                </li>

                <li class="submenu-item {{ $item_menu === 'harilibur' ? 'active' : '' }} ">
                    <a href="{{ url('harilibur') }}" class="submenu-link">Hari Libur</a>
                </li>

                <li class="submenu-item {{ $item_menu === 'tariflembur' ? 'active' : '' }} ">
                    <a href="{{ url('tariflembur') }}" class="submenu-link">Tarif Lembur</a>
                </li>

                <li class="submenu-item {{ $item_menu === 'pegawai' ? 'active' : '' }} ">
                    <a href="{{ url('pegawai') }}" class="submenu-link">Pegawai</a>
                </li>
        ...
        <li class="sidebar-item {{ $menu === 'perhitungan' ? 'active' : '' }} has-sub">
            <a href="#" class='sidebar-link'>
                <i class="bi bi-stack"></i>
            ...
            <ul class="submenu {{ $sub_menu === 'submenu' ? 'active' : '' }}">
                ...
                <li class="submenu-item {{ $item_menu === 'lembur' ? 'active' : '' }} ">
                    <a href="{{ url('lembur') }}" class="submenu-link">Lembur</a>
                </li>
            </ul>
