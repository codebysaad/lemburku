        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Jam Kerja</h3>
                    <p class="text-subtitle text-muted">Jam Kerja Pegawai IAIN Kudus</p>
                </div>
                ...
                <div class="modal-body">
                    <form id="addDataForm" name="addDataForm" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="time" id="awal" name="awal" required=""
                                    placeholder="name Details" class="form-control" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="time" id="akhir" name="akhir" required=""
                                    placeholder="name Details" class="form-control" />
                            </div>
                        </div>
                </div>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                $('body').on('click', '.editData', function() {
                    ...
                    $.get("{{ route('jamkerja.index') }}" + '/' + data_id + '/edit', function(data) {
                ...
                $('body').on('click', '.deleteData', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "DELETE",
                                url: "{{ route('jamkerja.store') }}" + '/' + data_id,
                                success: function(data) {
                                    table.draw();
                                    Swal.fire(
                                        'Deleted!',
